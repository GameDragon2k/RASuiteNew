...
void UpdateOverlay(HDC hdc, RECT rect, BOOL paused, ControllerInput input)
{
	...
	RA_UpdateRenderOverlay(hdc, &input, ((float)nDelta / 1000.0f), &rect, FALSE, paused);
}

void RenderAchievementsOverlay(HWND hwnd, BOOL paused, ControllerInput input) {
	...
	else
	{
		...
		// Update RA stuff
		UpdateOverlay(hdc, rect, paused, input);
